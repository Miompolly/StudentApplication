 ...
 <li><a href="applicant.jsp">Applicants</a></li>
  ...
  <div class="container">
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                <label for="Application" style="color:black;" >Application ID</label>
                <input type="number" class="form-control" name="Id" id="Id"  value="<%= request.getParameter("Id") %>" readonly>
            </div>
            <div class="form-group">
                <label for="review"  >Review</label>
                <input type="text" class="form-control" name="review" id="review"  value="<%= request.getParameter("review") %>" style="border:1px solid black;" >
            </div>
